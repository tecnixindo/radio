...
?>
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3" align="center">
        ...
        <br><img src="<?=$radio[$column_rating[0]][3]?>" height="90px" alt=""/><br><?=$radio[$column_rating[0]][2]?><br><span class="text-muted"><sub><?=$radio[$column_rating[0]][4]?>, <?=$radio[$column_rating[0]][5]?></sub><br><sup><?=$radio[$column_rating[0]][6]?></sup></span><br>
    	</a>
    </div>
<?php }?>
<?php
